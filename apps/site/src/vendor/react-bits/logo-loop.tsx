/* oxlint-disable typescript/no-explicit-any -- vendored from React Bits; kept close to upstream. */
/*
 * Vendored from React Bits (https://reactbits.dev) — LogoLoop (TypeScript + Tailwind variant).
