/*
 * Vendored from React Bits (https://reactbits.dev) — SpotlightCard (TypeScript + Tailwind variant).
...
const SpotlightCard: React.FC<SpotlightCardProps> = ({
  ...
  return (
    <div
      ...
      className={`relative rounded-2xl border border-fd-border/70 bg-fd-card overflow-hidden p-8 ${className}`}
    >
      <div
