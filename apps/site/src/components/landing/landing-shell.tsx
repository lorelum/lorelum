...
import { SmoothScroll, SMOOTH_CONTENT_ID, SMOOTH_WRAPPER_ID } from "./motion/smooth-scroll";
 ...
 */
export function LandingShell({ lang, children }: { lang: string; children: ReactNode }) {
  return (
    <>
